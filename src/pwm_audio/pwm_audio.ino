...
Riff humble = {{
    ...
    311.13, 311.13, 0, 0, 207.65, 0, 207.65, 0,   //beat 3
    0, 0, 207.65, 207.65, 329.63, 329.63, 0, 0    //beat 4
  }, 64, 100.15 //32 32nd notes in measure, 100.15 ms per 32nd note
};
...
Riff song_to_play = sorry;  //select one of the riff songs
